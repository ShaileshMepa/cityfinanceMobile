...
export class ClicktoSign extends Component {
  constructor(props) {
    super(props);
  ...
  async componentDidMount() {
    ...
    if (this.props.route.params.DocumentImages === undefined) {
    } else {
      this.setState({ DocumentImages: this.props.route.params.DocumentImages });
    }

    if (this.props.route.params.ref === undefined) {
    } else {
      this.setState({ ref: this.props.route.params.ref });
    }
                    ...
                    >
                      ...
                      >
                        <ImageBackground
                          style={{ width: 20, height: 20 }}
                          resizeMode="contain"
                          source={require("../assets/requiredDoc.png")}
                        ></ImageBackground>
                        <Text
                          style={{
                            color: "black",
                      ...
                      <View style={{ width: "40%" }}>
                        ...
                        >
                          Please Upload 2 Payslips and 3 references
                        </Text>
                      </View>
                    </View>
                  </View>
